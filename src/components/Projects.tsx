...
export default function Projects() {
  return (
    <section id="projects" className="section section-pad-bottom">
      <div className="container">
        <Divider />
        <div className={s.headerRow}>
          <div>
            <SectionHeader tag={PROJECTS_TAG} title={PROJECTS_TITLE} />
          </div>
          <a
            ...
            style={{ whiteSpace: "nowrap", transitionDelay: ".2s" }}
          >
            {PROJECTS_GITHUB_LABEL}
          </a>
        </div>
